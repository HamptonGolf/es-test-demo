...
function showFormMessage(message, type) {
    ...
    messageDiv.style.cssText = `
        ...
        background: ${type === 'success' ? '#8E7FA9' : '#D8747F'};
        color: white;
        padding: 30px 60px;
        font-size: 14px;
        letter-spacing: 2px;
...
// CONSOLE MESSAGE
// ==========================================
console.log('%c✨ Eclipse Studio', 'font-size: 20px; font-weight: 200; color: #8E7FA9; letter-spacing: 4px;');
